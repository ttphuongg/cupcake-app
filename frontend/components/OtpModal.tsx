 ...
 * Modal nhập mã OTP dùng chung cho: profile, change-password, delete-account.
 * Hỗ trợ 2 variant hiển thị:
 *   - 'center': modal ở giữa màn hình (profile, change-password)
 *   - 'bottom-sheet': modal từ dưới lên (delete-account)
 */
