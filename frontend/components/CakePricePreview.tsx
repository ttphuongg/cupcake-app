/**
 * components/CakePricePreview.tsx
 * "Linh hồn" của màn hình thiết kế:
 *  - Preview ảnh bánh thay đổi theo nguyên liệu đã chọn
 *  - Badge giá tổng cộng kết nối designStore
 *  - Scale animation theo kích cỡ bánh
 */
    ...
    <View style={styles.container}>
      ...
      <View style={styles.priceBadge}>
        <Text style={styles.priceBadgeText}>
          {totalPrice > 0 ? `${totalPrice.toLocaleString()}đ` : 'Chưa có giá'}
        </Text>
      </View>
    </View>
  );
